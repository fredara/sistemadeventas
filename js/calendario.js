...
var popCalendar = {
	...
	theme			: typeof theme == 'undefined' ? 'images' : theme,	// directory for images and styles ... e.g. var theme="default"
	...
	selectYearMessage	: {
		...
		de : "Klicken um Jahr auszuw&auml;len",
	...
	monthName			: {
		...
		pl : new Array("Styczeñ","Luty","Marzec","Kwiecieñ","Maj","Czerwiec","Lipiec","Sierpieñ","Wrzesieñ","Pa¼dziernik","Listopad","Grudzieñ"),
	...
	monthNameAbbr		: {
		...
		pl : new Array("Sty","Lut","Mar","Kwi","Maj","Cze","Lip","Sie","Wrz","Pa¬","Lis","Gru"),
	...
	dayName				: {
		...
		pl : new Array("Nd","Pn","Wt","¦r","Cz","Pt","Sb"),
	...
	init: function(installEventHandlers) {
		...
		document.write('<link rel="stylesheet" href="css/stylePOPCalendar.css" type="text/css" media="screen" />');
	...
	construct : function() {
		...
		for (var datePointer=1; datePointer <= numDaysInMonth; datePointer++) {
			...
			if (this.enablePast == 0 &&
				...
				(this.monthSelected == this.monthNow) &&
				(this.yearSelected == this.yearNow))) {			
				selDayAction = 'href="javascript:popCalendar.dateSelected='+datePointer+';popCalendar.close();"';// all CSS-classes with past-style are suffixed with "Past":
			} else {
			...
			if ((dayPointer+this.startAt) % 7 == this.startAt) {
				s += '</tr><tr>';
				if (this.showWeekNumber && (datePointer < numDaysInMonth)) {
	...
	show: function(ctl, ctl2, format, lang, past, fx, fy, start) {
		...
		this.enablePast = (past != null) ? past : 0;
