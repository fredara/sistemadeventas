...
$comp = new Compra();
$objCompras = $comp->ReporteCompras($desde, $hasta, $estado);
?>
<!DOCTYPE html PUBLIC>
<html lang="en">
    ...
    <main id="main2" class="main">
        ...
        <div class="container breadcrumb">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="borde_gris_bottom"><strong>Fecha Compra</strong></td>
                    <td class="borde_gris_bottom"><strong>Nro Compra</strong></td> 
                    <td class="borde_gris_bottom"><strong>Proveedor</strong></td>
                ...
                ?>
                            <tr>
                                <td class="borde_gris_bottom"><?php echo $obj->fecha_comp; ?></td>
                                <td class="borde_gris_bottom"><?php echo $obj->cod_compra; ?></td> 
                                <td class="borde_gris_bottom"><?php echo $obj->nombre_proveedor; ?></td>
