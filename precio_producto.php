...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
        ...
        <div class="row mb-3">
          <label class="col-sm-10"><h6 class="card-title">Precio Altual <?php echo @number_format($alm->precio, 1, ',', '.'); echo " $";?></h6></label>
        </div>
        ...
        <fieldset class="row mb-3">
            ...
            <div class="col-sm-9">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="option" id="gridRadios1" value="Cambiar Precio" required>
                    <label class="form-check-label" for="gridRadios1">
                    Cambiar Precio
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="option" id="gridRadios2" value="Ver Historico">
                    <label class="form-check-label" for="gridRadios2">
                    Ver Historico de Precio
                    </label>
                </div>
            </div>
        </fieldset>
        ...
        <div class="row mb-3">
          <label for="algo" class="col-sm-2"></label>
            <div class="col-sm-8">
                ...
                <input type="hidden" name="operacion" id="operacion" value="ajus_pre">
