    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="precio_producto_crear.php?cod_producto=<?php echo $cod_producto; ?>">Cambiar Precio</a></li>
        </ol>
    ...
    <section class="section dashboard">
        ...
        <div class="row mb-3">
            <div class="col-sm-8">
                ...
                <input type="hidden" name="operacion" id="operacion" value="mod_precio">
