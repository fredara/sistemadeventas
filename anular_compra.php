...
<head>
  ...
  <script type="text/javascript">
    ...
    function Anular(){
      if (!confirm('¿Desea Anular por Completo la Compra, se reversa las cantidades en almacen ?')){
        return false;
      }
    }
</script>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="listar_compra.php">Listado Compras</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <form class="row g-3 needs-validation" novalidate action="./controller/Compras.controller.php
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
              <button type="submit" class="btn btn-primary" id="anular_compra" onclick="return Anular();">Anular</button>
              <input type="hidden" name="operacion" id="operacion" value="anulaComp">
