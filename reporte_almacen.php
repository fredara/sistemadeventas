...
<body>
    ...
    <main id="main2" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="reporte_almacen.php">Reporte de Almacen</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <div class="container breadcrumb">
            <div class="row mb-12">
                <div class="col-lg-12">
                    <form action="reporte_almacen_imprimir.php" method="post" target="_blank">
                       

                        <div class="row mb-4">
                            <label for="tipo_reporte" class="col-sm-5 col-form-label">Reporte:</label>
                            <div class="col-sm-12">
                                <select name="tipo_reporte" id="tipo_reporte" class="form-select">
                                    <option value="" selected>General</option>
                                    <option value="Falla" >De Falla</option>
                                </select>
                            </div>
                        </div>
